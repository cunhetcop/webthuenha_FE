...
const routes: Routes = [
  ...
  { path : 'update/:id', component: UserUpdteComponent },
  { path : 'user/:id', component : UserProfileComponent },
  { path: 'orderPast/:start', component: OrderPastComponent},
  { path : 'booking/:start', component : BookingComponent },
  { path: 'orderWait/:start', component: OrderWaitComponent },
  { path: 'income', component: HouseIncomeComponent },
