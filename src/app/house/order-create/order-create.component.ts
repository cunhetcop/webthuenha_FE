...
export class OrderCreateComponent implements OnInit {
  ...
  sendMail() {
    this.emailDetails.subject = "VinTạy Group xin thông báo";
    ...
    this.emailDetails.msgBody = "Bạn có 1 order mới vào lúc: " + moment(this.order.createTime).format('LLLL') + "\n" +"Thời gian muốn thuê từ ngày " + moment(this.order.startTime).format('LL') + " đến ngày " + moment(this.order.endTime).format('LL') + "\n" +"Vui lòng vào kiểm tra và xác thực.";
